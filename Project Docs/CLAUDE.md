...
- The project owner determines phase count/order (rule 3) — no build roadmap beyond Phase 0 (discussion/spec) exists yet. Do not invent Phase 1+ definitions; wait for the owner's direction.
